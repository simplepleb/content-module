...
use Log;
use Modules\Content\Http\Requests\Backend\CategoriesRequest;
...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "content::backend.$module_path.index_datatable",
    ...
    public function create()
    {
        ...
        return view(
            "content::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        $contents = $$module_name_singular->contents()->latest()->paginate();

        Log::info(label_case($module_title.' '.$module_action).' | User:'.auth()->user()->name.'(ID:'.auth()->user()->id.')');

        return view(
            "content::backend.$module_name.show",
            compact('module_title', 'module_name', 'module_icon', 'module_name_singular', 'module_action', "$module_name_singular", 'contents')
        );
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            "content::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "content::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
