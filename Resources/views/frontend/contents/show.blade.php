...
<article>
    ...
    @php
    $post_details_url = route('frontend.contents.show',[encode_id($$module_name_singular->id), $$module_name_singular->slug]);
    @endphp
            ...
            <div class="col-12 col-lg-8">
                <div class="row">
                    <div class="col-9 col-md-6">
                        ...
                        <button class="btn btn-sm mr-3 btn-icon-only btn-pill btn-twitter d-inline" data-sharer="twitter" data-via="{{ config('app.name') }}" data-title="{{$title_text}}" data-hashtags="LaravelStarter" data-url="{{url()->full()}}" data-toggle="tooltip" title="Share on Twitter" data-original-title="Share on Twitter">
