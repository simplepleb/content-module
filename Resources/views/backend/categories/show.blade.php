                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="fa-ul">
                            ...
                            @endphp
                            <li>
                                <span class="fa-li"><i class="fas fa-check-square {{$text_class}}"></i></span> <a href="{{route('backend.contents.show', $row->id)}}">{{$row->name}}</a> <a href="{{route('frontend.contents.show', [encode_id($row->id), $row->slug])}}" class="btn btn-sm btn-outline-primary" target="_blank" data-toggle="tooltip" title="Public View" > <i class="fas fa-external-link-square-alt"></i> </a>
                            </li>
                            @empty
                            <p class="text-center">
                                No content found.
