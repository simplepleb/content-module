...
use Modules\Content\Entities\Presenters\ContentPresenter;
use Spatie\Activitylog\Traits\LogsActivity;
use Spatie\Feed\Feedable;
use Spatie\Feed\FeedItem;


class Content extends BaseModel implements Feedable
{
    use HasFactory;
    use LogsActivity;
    use SoftDeletes;
    ...
    protected static $logName = 'contents';
    ...
    {
        return $this->belongsTo('Modules\Content\Entities\Category');
    }
    ...
    /**
     * Get the list of Published Contents.
     *
    ...
    /**
     * Get the list of Recently Published Contents.
     *
     * @param [type] $query [description]
     *
     * @return [type] [description]
    ...
    public function toFeedItem()
    {
        ...
        return FeedItem::create()
                        ...
                        ->link(route('frontend.contents.show', encode_id($this->id)))
                        ->author($author);
    }
